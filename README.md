...
# Worker
docker run -it --rm -v /var/run/docker.sock:/var/run/docker.sock -v $(pwd)/data:/results -e HYPERDOCK_RESULT_DIR=$(pwd)/data -e MONGO_URL=mongo://172.17.0.1:27017/hyperdock erikgartner/hyperdock-worker:latest
```
